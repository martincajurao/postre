...
<script setup>
import { ref, getCurrentInstance, onMounted, inject, computed, reactive } from "vue";
...
const rawMenuCategories = [
  { id: 'beef', name: 'Beef Dishes', icon: 'mdi-food-steak', code: 'BF', description: 'Delicious beef dishes.' },
  { id: 'chicken', name: 'Chicken Dishes', icon: 'mdi-food-drumstick', code: 'CH', description: 'Savory chicken dishes.' },
  { id: 'seafood', name: 'Seafood Dishes', icon: 'mdi-fish', code: 'SF', description: 'Fresh seafood dishes.' },
  { id: 'pork', name: 'Pork Dishes', icon: 'mdi-pig', code: 'PO', description: 'Tender pork dishes.' },
  { id: 'vegetables', name: 'Vegetable Dishes', icon: 'mdi-carrot', code: 'VG', description: 'Healthy vegetable options.' },
  { id: 'desserts', name: 'Desserts', icon: 'mdi-cake', code: 'DS', description: 'Sweet treats.' },
];

const menuCategories = computed(() => rawMenuCategories); // Use a computed property
...
onMounted(async () => {
  ...
  onValue(dbRef, (snapshot) => {
    ...
    if (fetchedData) {
      Object.assign(data, fetchedData);
    }
